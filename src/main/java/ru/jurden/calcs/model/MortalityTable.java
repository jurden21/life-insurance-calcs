...
public class MortalityTable {
    ...
    /**
     * <p>Значение l<sub>x</sub> - показатель таблицы смертности, характеризующий число лиц из наблюдаемой
     * совокупности, доживших до возраста x лет. Значения l приводятся в таблице смертности при целых x
     * (x = 0, 1, 2,.. w, где w - предельный возраст таблицы смертности).</p>
     */
    ...
    /**
     * <p>Значение d<sub>x</sub> = l<sub>x</sub> - l<sub>x+1</sub> - показатель таблицы смертности,
     * характеризующий число лиц, умерших в возрасте от x лет до возраста x+1 год.</p>
     */
    ...
    /**
     * <p>Значение <sub>n</sub>p<sub>x</sub> = l<sub>x+n</sub> / l<sub>x</sub> - вероятность для лица в
     * возрасте x лет дожить до возраста x+n лет.</p>
     */
    ...
    /**
     * <p>Значение <sub>n</sub>q<sub>x</sub> = (l<sub>x</sub> - l<sub>x+n</sub>) / l<sub>x</sub> -
     * вероятность для лица в возрасте x лет умереть в течение предстоящих n лет.</p>
     */
